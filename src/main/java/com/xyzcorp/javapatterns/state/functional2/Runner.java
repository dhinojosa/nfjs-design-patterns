...
import com.xyzcorp.javapatterns.state.enums.Player;
import com.xyzcorp.javapatterns.state.enums.TennisGame;

public class Runner {
    public static void main(String[] args) {
        TennisGame tennisGame = TennisGame.start(new com.xyzcorp.javapatterns.state.enums.Player("Salvador"),
            new Player("Rafael"));
